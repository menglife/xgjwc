...
<script type="text/javascript">
    ...
    $(function () {
        ...
        dataGrid = $("#kcdg").datagrid({
            ...
            frozenColumns:[[
                {field:"name",title:"所属学院",width:100,
                ...
                {field:"termname",title:"学期",width:80,
                    formatter: function(value,row,index){
                        if(row.term){
    ...
    function datacheck() {
        ...
        dataGrid = $("#kcdg").datagrid({
            ...
            columns: [[
                ...
                {field: "sumgzl", title: "总工作量", width: 100},
                {field: "cwd", title: "正确性", width: 100,styler:cellStyler},
                {field: "jy", title: "校验后", width: 100},
                {field: "errmsg", title: "校验前", width: 100}
